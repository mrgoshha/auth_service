...
import (
	auth "AuthenticationService/pkg/auth"
	reflect "reflect"
...
func (m *MockTokenManager) NewJWT(userId, userIP, sessionID string) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewJWT", userId, userIP, sessionID)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockTokenManagerMockRecorder) NewJWT(userId, userIP, sessionID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewJWT", reflect.TypeOf((*MockTokenManager)(nil).NewJWT), userId, userIP, sessionID)
}
...
func (m *MockTokenManager) Parse(accessToken string) (*auth.TokenPayload, error) {
	m.ctrl.T.Helper()
